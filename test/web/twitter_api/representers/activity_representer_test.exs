...
defmodule Pleroma.Web.TwitterAPI.Representers.ActivityRepresenterTest do
  ...
  test "an activity" do
    ...
    expected_html =
      "<p>2hu <img class=\"emoji\" alt=\"2hu\" title=\"2hu\" src=\"corndog.png\" /></p>alert('YAY')Some <img class=\"emoji\" alt=\"2hu\" title=\"2hu\" src=\"corndog.png\" /> content mentioning <a href=\"#{
        mentioned_user.ap_id
      }\">@shp</a>"
    ...
    expected_status = %{
      ...
      "summary" => "2hu :2hu:",
      "summary_html" =>
        "2hu <img class=\"emoji\" alt=\"2hu\" title=\"2hu\" src=\"corndog.png\" />"
    }
